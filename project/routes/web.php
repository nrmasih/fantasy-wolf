...
// Verification Section Ends
    ...
    Route::group(['middleware' => 'permissions:vendor_subscription_plans'], function() {
        ...
        //
        Route::get('/wholesale/datatables', 'Admin\WholesaleController@datatables')->name('admin-wholesale-datatables');
        Route::get('/wholesale', 'Admin\WholesaleController@index')->name('admin-wholesale-index');
        Route::get('/wholesale/create', 'Admin\WholesaleController@create')->name('admin-wholesale-create');
        Route::post('/wholesale/create', 'Admin\WholesaleController@store')->name('admin-wholesale-store');
        Route::get('/wholesale/view/{id}', 'Admin\WholesaleController@view')->name('admin-wholesale-view');
        Route::post('/wholesale/edit/{id}', 'Admin\WholesaleController@update')->name('admin-wholesale-update');
        Route::get('/wholesale/delete/{id}', 'Admin\WholesaleController@destroy')->name('admin-wholesale-delete');
        //
...
Route::prefix('user')->group(function() {
    ...
    //Load Chat //
    Route::get('/load-chat', 'User\MessageController@loadChat')->name('loadChat');
    // User Profile
...
// ************************************ FRONT SECTION **********************************************
    ...
    // BLOG SECTION
    Route::get('/press', 'Front\FrontendController@blog')->name('front.blog');
    Route::get('/press/{id}', 'Front\FrontendController@blogshow')->name('front.blogshow');
    Route::get('/press/category/{slug}', 'Front\FrontendController@blogcategory')->name('front.blogcategory');
    Route::get('/press/tag/{slug}', 'Front\FrontendController@blogtags')->name('front.blogtags');
    Route::get('/press-search', 'Front\FrontendController@blogsearch')->name('front.blogsearch');
    Route::get('/press/archive/{slug}', 'Front\FrontendController@blogarchive')->name('front.blogarchive');
    // BLOG SECTION ENDS
    // FAQ SECTION
    Route::get('/faq', 'Front\FrontendController@faq')->name('front.faq');
    // FAQ SECTION ENDS
    // CONTACT SECTION
    Route::get('/contact-us', 'Front\FrontendController@contact')->name('front.contact');
    ...
    // CATEGORY SECTION
    Route::get('/collections/{category?}/{subcategory?}/{childcategory?}', 'Front\CatalogController@category')->name('front.collections');
    Route::get('/shop/{category?}/{subcategory?}/{childcategory?}', 'Front\CatalogController@category')->name('front.shop');
    ...
    /* New Arrivals */
    Route::get('/new-arrivals/', 'Front\CatalogController@category')->name('front.newArrivals');
    Route::get('/best-sellers/', 'Front\CatalogController@category')->name('front.bestSellers');
    /**/
    ...
    // CRONJOB ENDS
    //NEERAJ MASIH
    Route::get('/postSubscription', 'Front\CartController@postSubscription')->name('front.postSubscription');
    Route::get('/getCartVal', 'Front\CartController@getCartVal')->name('front.getCartVal');
    Route::get('/reviews', 'Front\FrontendController@reviews')->name('front.reviews');
    Route::get('/about-us', 'Front\FrontendController@aboutus')->name('front.aboutus');
    ...
    Route::get('/help', 'Front\FrontendController@help')->name('front.help');
    Route::get('/shipping-returns', 'Front\FrontendController@shippingReturns')->name('front.shippingReturns');

    Route::get('/corporate-gifts', 'Front\FrontendController@corporate')->name('front.corporate');
    Route::get('/wholesale', 'Front\FrontendController@wholesale')->name('front.wholesale');

    Route::get('/our-products', 'Front\FrontendController@ourProducts')->name('front.ourProducts');

    Route::post('/form-retailer', 'Front\FrontendController@formRetailer')->name('front.formRetailer');
    Route::post('/form-distributor', 'Front\FrontendController@formDistributor')->name('front.formDistributor');

    // Developer //


    Route::get('/reset-password/{email}', 'Front\FrontendController@resetPassword')->name('front.resetPassword');
    Route::get('/forgot-password', 'Front\FrontendController@forgotPassword')->name('front.forgotPassword');
    Route::get('/register', 'Front\FrontendController@register')->name('front.register');
