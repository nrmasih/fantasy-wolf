...
<div class="content-area">
  ...
  <?php endif; ?>
    ...
    <div class="row row-cards-one">
        <div class="col-md-12 col-lg-6 col-xl-4" style="display: none;">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg4">
                <div class="left">
                    <h5 class="title"><?php echo e(__('Total Users!')); ?></h5>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg5">
                <div class="left">
                    <h5 class="title"><?php echo e(__('Total Feeds!')); ?></h5>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg6">
                <div class="left">
                    <h5 class="title"><?php echo e(__('Total Join Team!')); ?></h5>
    ...
    <div class="row row-cards-one" style="display: none;">
