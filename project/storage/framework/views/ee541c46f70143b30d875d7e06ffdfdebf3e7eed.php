               ...
               <div class="col-xl-6 col-lg-8 col-md-10 col-12 order-md-1 fxt-bg-color">
                  <div class="fxt-content aos-init aos-animate " data-aos="fade-in">
                     ...
                     <div class="fxt-form">
                        ...
                        <form data="<?php echo e(route('user.login.submit')); ?>" method="POST" id="userLogin" >
                           ...
                           <div class="form-group">
                              <div class="fxt-checkbox-area">
                                 ...
                                 <a href="<?php echo e(route('front.forgotPassword')); ?>" class="switcher-text ">Forgot Password</a>
                              </div>
                           </div>
                           <div class="form-group">
                              <input type="hidden" name="action" value="<?php echo e(route('user-dashboard')); ?>">
                              <button type="submit" class="btn-block btn btn-primary btn-round-xl userLogin">Log in</button>
                           </div>
                        </form>
                     </div>
                     <div class="fxt-footer">
                        <p class=" ">Don't have an account?&nbsp;<a href="<?php echo e(route('front.register')); ?>" class="switcher-text ">Register</a></p>
