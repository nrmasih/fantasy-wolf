                  ...
                  <div class="tab-content" id="pills-tabContent">
                     <div class="tab-pane fade show active" id="pills-feed" role="tabpanel" aria-labelledby="pills-feed-tab">
                        <div class="postLisitng">
                           <a href="<?php echo e(route('user.postlisting')); ?>" class="btn btn-sm btn-primary btn-round-xl d-flex flex-wrap mx-1"><i class="bx bx-user-plus mr-1"></i>Post a Listing</a>
                        </div>
                        <div class="row mx-0">
                            ...
                            <div class="col-md-12 px-3">
                              <div class="col teamCSextion d-flex flex-wrap mb-4">
                                 <div class="teamList d-flex flex-wrap align-items-center">
                                    ...
                                    <div class="picx">
                                       <img src="<?php echo e(url('public/assets/images/user2.png')); ?>" width="86">
                                    </div>
                                 ...
                                 <div class="d-flex flex-wrap align-items-center ml-4">
                                    ...
                                    <div class="ml-4 team-logo">
                                       <img src="<?php echo e(url('public/assets/images/teamLogo.png')); ?>" width="86">
                                    </div>
                                 </div>
                            ...
                            <div class="col-md-12 px-3">
                              <div class="col teamCSextion teamCSextion2 d-flex flex-wrap mb-4">
                                 <div class="teamList d-flex flex-wrap align-items-center">
                                    ...
                                    <div class="picx">
                                       <img src="<?php echo e(url('public/assets/images/user3.png')); ?>" width="86">
                                    </div>
                                    <div class="ml-4 listName">
                                       <h5 class="mb-0">Kobe Bryant</h5>
                                       <div class="des">
                           ...
                           <div class="col-md-12 px-3">
                              <div class="bg-img-none col teamCSextion d-flex flex-wrap mb-4">
                                 <div class="col teamList d-flex flex-wrap align-items-center px-0">
                                    <div class="picx">
                                       <img src="<?php echo e(url('public/uploads/users/thumbnail/'.Auth::user()->photo)); ?>" width="86">
                                    </div>
                                    <div class="ml-4 listName">
                                 ...
                                 <div class="col d-flex flex-wrap align-items-center ml-4">
                                    <div class="ml-4 listName mr-4">
                                       <h5>About</h5>
                                       <p class="mb-0"> <?php echo e(Auth::user()->bio); ?>  </p>
                                    </div>
                                 </div>
                                          ...
                                          <table class="table table-borderd">
                                             ...
                                             <tbody>
                                                <tr>
                                                   ...
                                                   <td class="align-middle">
                                                      <div class="chat_img"> <img src="<?php echo e(url('public/assets/images/profile_img.png')); ?>" alt="sunil" class="img-fluid"> </div>
                                                   </td>
                                                   <td class="align-middle">
                                                   ...
                                                   <td class="align-middle">
                                                      <div class="team-logo-xs">
                                                         <img src="<?php echo e(url('public/assets/images/teamLogo.png')); ?>" class="img-fluid">
                                                      </div>
                                                   </td>
