                           ...
                           <div class="row mx-0 mt-4">
                              ...
                              <div class="col-md-12 px-3">
                                 <div class="bg-img-none col teamCSextion d-flex flex-wrap mb-4 py-4">
                                    <form class="form w-100" novalidate="" method="POST" data="<?php echo e(route('user.updateProfile')); ?>" enctype="multipart/form-data">
                                          ...
                                          <div class="col">
                                             <div class="row">
                                                <div class="col-md-6 col-lg-6">
                                                   <div class="form-group">
                                                      ...
                                                      <input name="first_name" value="<?php echo e(Auth::user()->first_name); ?>" class="form-control" type="text" name="fNAme" placeholder="Enter your first name"/>
                                                   </div>
                                                </div>
                                                <div class="col-md-6 col-lg-6">
                                                   <div class="form-group">
                                                      <label>Last Name</label>
                                                      <input name="last_name" value="<?php echo e(Auth::user()->last_name); ?>" class="form-control" type="text" name="lNAme" placeholder="Enter your last name"/>
                                                   </div>
                                                </div>
                                                <div class="col-md-6 col-lg-6">
                                                   <div class="form-group">
                                                      <label>Username</label>
                                                      <input name="name" value="<?php echo e(Auth::user()->name); ?>" class="form-control" type="text" name="username" placeholder="Enter your username"/>
                                                   </div>
                                                </div>
                                                <div class="col-md-6 col-lg-6">
                                                   <div class="form-group">
                                                      <label>Email</label>
                                                      <input  value="<?php echo e(Auth::user()->email); ?>" class="form-control" type="email" placeholder="Enter your email id">
                                                   </div>
                                                </div>
                                             </div>
                                             <div class="row">
                                                <div class="col-md-6 col-lg-6">
                                                   <div class="form-group">
                                                      ...
                                                      <input name="phone" value="<?php echo e(Auth::user()->phone); ?>" class="form-control" type="text" placeholder="Enter your phone no." required="required">
                                                   </div>
                                                </div>
                                                <div class="col-md-6 col-lg-6">
                                                   <div class="form-group">
                                                      <label>Age</label>
                                                      <input name="age" value="<?php echo e(Auth::user()->age); ?>" class="form-control" type="date" placeholder="Enter your age">
                                                   </div>
                                                </div>
                                             </div>
                                             <div class="row">
                                                <div class="col-md-6 col-lg-4">
                                                   <div class="form-group">
                                                      <label>Country</label>
                                                      <select id="country_id"  name="country_id" class="form-control" onchange="getstatebyid(this.value,'<?php echo e(route('ajaxState')); ?>')">
                                                         <option>Select your country</option>
                                                                ...
                                                                <option <?php if(Auth::user()->country_id==$r->country_id): ?> selected <?php endif; ?>   value="<?php echo e($r->country_id); ?>"> <?php echo e($r->name); ?> </option>
                                                ...
                                                <div class="col-md-6 col-lg-4">
                                                   <div class="form-group">
                                                      <label>State</label>
                                                      <select id="state_id" name="state_id" onchange="getcitybyid(this.value,'<?php echo e(route('ajaxCity')); ?>')" class="form-control">
                                             ...
                                             <div class="row">
                                                <div class="col col-md-12 mb-3">
                                                   <div class="form-group">
                                                      <label>About</label>
                                                      <textarea name="bio" class="form-control" rows="5" placeholder="Enter your bio"><?php echo e(Auth::user()->bio); ?></textarea>
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
...
<script type="text/javascript">
    ...
    setTimeout(function () {
    getstatebyid('<?php echo e(Auth::user()->country_id); ?>','<?php echo e(route('ajaxState')); ?>');
    getcitybyid('<?php echo e(Auth::user()->state_id); ?>','<?php echo e(route('ajaxCity')); ?>');

        setTimeout(function () {
            <?php if(!empty(Auth::user()->state_id)): ?>
            jQuery("#state_id").val(<?php echo e(Auth::user()->state_id); ?>).trigger("chosen:updated");
            <?php endif; ?>
            
            <?php if(!empty(Auth::user()->city_id)): ?>
            jQuery("#city_id").val(<?php echo e(Auth::user()->city_id); ?>).trigger("chosen:updated");
            <?php endif; ?>
