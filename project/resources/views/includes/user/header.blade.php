<header>
    <nav class="sb-topnav navbar navbar-expand navbar-light bg-theme shadow-sm">
        ...
        <a class="order-2 order-lg-0 navbar-brand" href="{{url('/')}}">
            <!-- <img src="{{asset('assets/images/'.$gs->footer_logo)}}" alt="Logo" data-aos="zoom-in" width="116px"> -->
        ...
        <ul class=" order-3 order-lg-0 navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a target="_blank" class="nav-link text-white" href="{{url('/about-us')}}">About Us</a>
            </li>
            <li class="nav-item">
                <a target="_blank" class="nav-link text-white" href="{{url('/contact-us')}}">Contact Us</a>
            </li>
        </ul>
        ...
        <ul class=" order-5 order-lg-0 navbar-nav ml-auto ml-md-0">
            <li class="nav-item dropdown">
                <a class="py-0 media dtan pl-0 text-white align-items-center nav-link dropdown-toggle" id="userDropdown" href="javaScript:void(0)" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="round2">
                        <img class="mr-2" src="{{url('public/uploads/users/thumbnail/'.Auth::user()->photo)}}" width="40" height="40" alt="{{Auth::user()->name}}">
                    </div>
                </a>
                <div class="dropdown-menu shadow-lg dropdown-menu shadow-lg-right" aria-labelledby="userDropdown">
                    <a class="dropdown-item" href="{{route('edit-profile')}}"><i class="mr-2 bx bx-edit-alt"></i> Edit Profile</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="{{route('user-logout')}}"><i class="mr-2 bx bx-log-out"></i>Logout</a>
                </div>
            </li>
        </ul>
    </nav>
