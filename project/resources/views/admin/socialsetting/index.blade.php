            ...
            <div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
              ...
              @include('includes.admin.form-both')  
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <label class="switch">
                      <input type="checkbox" name="inst_status" value="1" {{$data->inst_status==1?"checked":""}}>
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
               ...
               <div class="row">
                  ...
                  <div class="col-sm-3">
                    <label class="switch">
                      <input type="checkbox" name="you_status" value="1" {{$data->you_status==1?"checked":""}}>
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
                ...
                <div class="row">
                  <label class="control-label col-sm-3" for="pinterest">{{ 'Pinterest' }} *</label>
                  <div class="col-sm-6">
                  ...
                  <div class="col-sm-3">
                    <label class="switch">
                      <input type="checkbox" name="pint_status" value="1" {{$data->pint_status==1?"checked":""}}>
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
